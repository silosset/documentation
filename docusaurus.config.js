...
module.exports = {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      logo: {
        alt: 'Site Logo',
        src: `/logos/silosset-word-dark.svg`,
        srcDark: `/logos/silosset-word-light.svg`,
        href: '/',
        target: '_self',
        width: 100,
      },
      items: [
        ...
        },
        {
          label: 'Support',
          position: 'right',
          href: 'https://silosset.com/support',
          label: 'Help Center',
          target: '_blank',
        ...
        {
          href: 'https://github.com/silosset/documentation',
          position: 'right',
